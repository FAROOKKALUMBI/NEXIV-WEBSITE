...
export function PageProjectCta({ onOpenContact }: { onOpenContact: () => void }) {
  return (
    <section className="bg-[#f5f5f5] px-5 py-16 sm:px-10 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-[1040px] rounded-2xl bg-[#293541] px-6 py-12 text-center shadow-2xl sm:px-12 sm:py-16">
        ...
        <button onClick={onOpenContact} className="mt-8 inline-flex items-center gap-2 rounded-md bg-[#afe714] px-5 py-3 font-inter text-sm font-bold text-[#293541] transition-all hover:bg-white hover:scale-[1.02]">
