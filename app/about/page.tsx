...
export default function AboutPage() {
  ...
  const selectTab = (id: string) => { setActiveTab(id); window.history.replaceState(null, "", `#${id}`); document.getElementById("about-content")?.scrollIntoView({ behavior: "smooth", block: "start" }); };
